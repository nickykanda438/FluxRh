                    ...
                    <form action="{{ route('stagiaires.store') }}" method="POST" class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="domaine_etude_ou_competence" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:text-white">
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date Début</label>
                                <input type="date" name="date_debut" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:text-white" required>
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date Fin</label>
                                <input type="date" name="date_fin" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:text-white" required>
                            </div>
                            <div>
                        ...
                        <tbody>
                            @forelse($stagiaires as $stagiaire)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">Du {{ $stagiaire->date_debut->format('d/m/Y') }} au {{ $stagiaire->date_fin->format('d/m/Y') }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-6 text-center text-gray-500">Aucun stagiaire trouvé.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
